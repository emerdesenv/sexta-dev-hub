        ...
        <main class="container">
            <section class="card hero">
                <div>
                    ...
                    <p>Plataforma de microlearning com conteúdos do <b>Sexta Dev</b>, desenvolvida para apoiar alunos no aprendizado de desenvolvimento de software.</p>
                    <p>Aqui você encontra <b>episódios curtos com PDF e áudio</b>, abordando temas práticos do mercado de tecnologia como boas práticas de código, versionamento, arquitetura e desenvolvimento profissional.</p>
            ...
            <section class="filters" id="episodios">
                ...
                <button class="button info" @click="loadEpisodes">Filtrar</button>
            </section>
