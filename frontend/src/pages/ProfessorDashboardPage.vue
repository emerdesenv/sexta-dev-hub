        ...
        <main class="container admin-layout">
            <aside class="card sidebar">
                <div style="display:grid; gap:10px;">
                    ...
                    <button class="button secondary" @click="auth.logout(); router.push('/')">Sair</button>
                </div>
            </aside>
            ...
            <section class="grid">
                ...
                <div class="card" style="padding:20px; overflow:auto;">
                    <div style="display:flex; justify-content:space-between; gap:12px; align-items:center; flex-wrap:wrap;">
                        ...
                        <span class="badge">{{ episodes.length }} registro(s)</span>
                    </div>

                    <table class="table">
                        <thead>
                            <tr><th>Título</th><th>Ano</th><th>Status</th><th>Categoria</th><th class="center">Ações</th></tr>
                        </thead>
                        <tbody>
